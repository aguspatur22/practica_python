string = """# <img alt="NumPy" src="/branding/logo/primary/numpylogo.svg" height="60">
...
for elem in lineas:
    if ("http" or "https") in elem:
      print(elem)

#EJ 2

lista_string = string.replace("-","").split()
dicc = {}
for x in lista_string:
    dicc[x] = lista_string.count(x)
...
print(dicc)
print("Palabra mas veces: {} Numero de veces: {}".format(maxClave,dicc[maxClave]))